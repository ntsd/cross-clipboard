...
func newListResources(fonts *Fonts) (*listResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile("assets/graphics/list-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/list-disabled.png")
	if err != nil {
		return nil, err
	}

	mask, _, err := ebitenutil.NewImageFromFile("assets/graphics/list-mask.png")
	if err != nil {
		return nil, err
	}

	trackIdle, _, err := ebitenutil.NewImageFromFile("assets/graphics/list-track-idle.png")
	if err != nil {
		return nil, err
	}

	trackDisabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/list-track-disabled.png")
	if err != nil {
		return nil, err
	}

	handleIdle, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-handle-idle.png")
	if err != nil {
		return nil, err
	}

	handleHover, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-handle-hover.png")
	if err != nil {
		return nil, err
	}
...
func newSliderResources() (*sliderResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-track-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-track-disabled.png")
	if err != nil {
		return nil, err
	}
	...
	handleDisabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-handle-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newProgressBarResources() (*progressBarResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile("assets/graphics/progressbar-track-idle.png")
	if err != nil {
		return nil, err
	}
	fill_idle, _, err := ebitenutil.NewImageFromFile("assets/graphics/progressbar-fill-idle.png")
	if err != nil {
		return nil, err
	}
	disabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/slider-track-disabled.png")
...
func newTabBookResources(fonts *Fonts) (*tabBookResources, error) {
	selectedIdle, err := loadImageNineSlice("assets/graphics/button-selected-idle.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedHover, err := loadImageNineSlice("assets/graphics/button-selected-hover.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedPressed, err := loadImageNineSlice("assets/graphics/button-selected-pressed.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedDisabled, err := loadImageNineSlice("assets/graphics/button-selected-disabled.png", 12, 0)
	if err != nil {
		return nil, err
	}
...
func newTextInputResources(fonts *Fonts) (*textInputResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile("assets/graphics/text-input-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile("assets/graphics/text-input-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newToolTipResources(fonts *Fonts) (*toolTipResources, error) {
	bg, _, err := ebitenutil.NewImageFromFile("assets/graphics/tool-tip.png")
	if err != nil {
		return nil, err
	}
